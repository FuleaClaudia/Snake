export default class Snake {
    constructor(scene){
        ...
        this.scene.add.rectangle(
            ...
            this.tileSize,
            this.tileSize,0xff0000).setOrigin(0));
        
        this.apple = this.scene.add.rectangle(100,100,this.tileSize,this.tileSize,0x3365FF).setOrigin(0);
        this.positionApple();
    ...
    move(){
       /* this.body[2].x =this.body[1].x;
        ...
        if(this.apple.x === x && this.apple.y ===y){
            //eaten the apple
            this.body.push(this.scene.add.rectangle(0,0,this.tileSize,this.tileSize, 0xfffff).setOrigin(0));
            this.positionApple();
        }
        ...
        //snakes die by eating its own tail
